...
You declare a gluon by calling the `gluon` funcition and passing the name of the gluon
...
This gluon is not persistent actually, it's just a variable that can be used across
your application with every power of a gluon (subscription, set, get), just no persisted...
